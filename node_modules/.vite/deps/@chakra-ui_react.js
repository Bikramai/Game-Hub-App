...
function useImage(props) {
  ...
  const [status, setStatus] = (0, import_react65.useState)("pending");
  (0, import_react65.useEffect)(() => {
    setStatus(src ? "loading" : "pending");
  }, [src]);
  const imageRef = (0, import_react65.useRef)();
...
var AvatarGroup = forwardRef(
  function AvatarGroup2(props, ref) {
    ...
    const clones = reversedChildren.map((child, index2) => {
      ...
      return (0, import_react68.cloneElement)(child, compact2(childProps));
    });
    const groupStyles = {
      display: "flex",
      alignItems: "center",
...
var Breadcrumb = forwardRef(
  function Breadcrumb2(props, ref) {
    ...
    const clones = validChildren.map(
      (child, index2) => (0, import_react70.cloneElement)(child, {
        separator,
        spacing,
...
function useCheckbox(props = {}) {
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react80.useState)(false);
  const [isFocused, setFocused] = (0, import_react80.useState)(false);
  const [isHovered, setHovered] = (0, import_react80.useState)(false);
  const [isActive, setActive] = (0, import_react80.useState)(false);
  (0, import_react80.useEffect)(() => {
    return trackFocusVisible(setIsFocusVisible);
  }, []);
  const inputRef = (0, import_react80.useRef)(null);
  const [rootIsLabelElement, setRootIsLabelElement] = (0, import_react80.useState)(true);
  const [checkedState, setCheckedState] = (0, import_react80.useState)(!!defaultChecked);
  ...
  const onKeyUp = (0, import_react80.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getIndicatorProps = (0, import_react80.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
      ref: forwardedRef,
      "data-active": dataAttr(isActive),
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const clonedIcon = (0, import_react81.cloneElement)(icon, {
    __css: iconStyles,
...
function useCounter(props = {}) {
  ...
  const onChangeProp = useCallbackRef(onChange);
  const [valueState, setValue] = (0, import_react82.useState)(() => {
    var _a2;
  ...
  const update = (0, import_react82.useCallback)(
    (next) => {
      if (next === value)
        return;
      if (!isControlled) {
  ...
  const clamp2 = (0, import_react82.useCallback)(
    (value2) => {
  ...
  const castValue = (0, import_react82.useCallback)(
    (value2) => {
      var _a2;
...
function useEditable(props = {}) {
  ...
  const [isEditing, setIsEditing] = (0, import_react84.useState)(defaultIsEditing);
  const [value, setValue] = useControllableState({
    defaultValue: defaultValue || "",
    value: valueProp,
    onChange: onChangeProp
  ...
  const editButtonRef = (0, import_react84.useRef)(null);
  const cancelButtonRef = (0, import_react84.useRef)(null);
  const submitButtonRef = (0, import_react84.useRef)(null);
  ...
  const onEdit = (0, import_react84.useCallback)(() => {
    if (isInteractive) {
      setIsEditing(true);
    }
  }, [isInteractive]);
  const onUpdatePrevValue = (0, import_react84.useCallback)(() => {
    setPrevValue(value);
  }, [value]);
  const onCancel = (0, import_react84.useCallback)(() => {
    setIsEditing(false);
    setValue(prevValue);
    onCancelProp == null ? void 0 : onCancelProp(prevValue);
    onBlurProp == null ? void 0 : onBlurProp(prevValue);
  }, [onCancelProp, onBlurProp, setValue, prevValue]);
  const onSubmit = (0, import_react84.useCallback)(() => {
    setIsEditing(false);
    setPrevValue(value);
  ...
  const onKeyDownWithoutSubmit = (0, import_react84.useCallback)(
    (event) => {
      const eventKey = event.key;
      const keyMap = {
        Escape: onCancel
  ...
  const onBlur3 = (0, import_react84.useCallback)(
    (event) => {
      var _a2;
      if (!isEditing)
        return;
  ...
  const getPreviewProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getTextareaProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      hidden: !isEditing,
      placeholder,
  ...
  const getEditButtonProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Edit",
      ...props2,
      type: "button",
  ...
  const getSubmitButtonProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      "aria-label": "Submit",
  ...
  const getCancelButtonProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => ({
      "aria-label": "Cancel",
      id: "cancel",
      ...props2,
...
function useCallbackRef2(initialValue, callback) {
  var ref = (0, import_react85.useState)(function() {
    return {
      // value
      value: initialValue,
      // last callback
  ...
  return function wrap4(WrappedComponent) {
    ...
    var SideEffect = function(_PureComponent) {
      ...
      _proto.render = function render() {
        return import_react89.default.createElement(WrappedComponent, this.props);
      };
      return SideEffect2;
    }(import_react89.PureComponent);
...
var List = forwardRef(function List2(props, ref) {
  ...
  return (0, import_jsx_runtime60.jsx)(ListStylesProvider, { value: styles, children: (0, import_jsx_runtime60.jsx)(
    chakra.ul,
    {
      ref,
...
var OrderedList = forwardRef((props, ref) => {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime60.jsx)(List, { ref, as: "ol", styleType: "decimal", marginStart: "1em", ...rest });
});
OrderedList.displayName = "OrderedList";
var UnorderedList = forwardRef(function UnorderedList2(props, ref) {
  const { as, ...rest } = props;
  return (0, import_jsx_runtime60.jsx)(List, { ref, as: "ul", styleType: "initial", marginStart: "1em", ...rest });
});
UnorderedList.displayName = "UnorderedList";
var ListItem = forwardRef(function ListItem2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime60.jsx)(chakra.li, { ref, ...props, __css: styles.item });
});
ListItem.displayName = "ListItem";
var ListIcon = forwardRef(function ListIcon2(props, ref) {
  const styles = useListStyles();
  return (0, import_jsx_runtime60.jsx)(Icon, { ref, role: "presentation", ...props, __css: styles.icon });
});
...
var Grid = forwardRef(function Grid2(props, ref) {
  ...
  return (0, import_jsx_runtime61.jsx)(chakra.div, { ref, __css: styles, ...rest });
});
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react117.useMemo)(
    () => shouldWrapChildren ? import_react117.Children.map(children, (child, index2) => (0, import_jsx_runtime64.jsx)(WrapItem, { children: child }, index2)) : children,
    [children, shouldWrapChildren]
  );
  return (0, import_jsx_runtime64.jsx)(chakra.div, { ref, className: cx("chakra-wrap", className), ...rest, children: (0, import_jsx_runtime64.jsx)(
    chakra.ul,
    {
...
var StackDivider = (props) => (0, import_jsx_runtime65.jsx)(
  chakra.div,
  {
...
var StackItem = (props) => (0, import_jsx_runtime66.jsx)(
  chakra.div,
  {
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react118.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index2) => {
      ...
      const wrappedChild = (0, import_jsx_runtime67.jsx)(StackItem, { children: child }, key);
      ...
      return (0, import_jsx_runtime67.jsxs)(import_react118.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
var VStack = forwardRef((props, ref) => (0, import_jsx_runtime68.jsx)(Stack, { align: "center", ...props, direction: "column", ref }));
VStack.displayName = "VStack";

// node_modules/@chakra-ui/layout/dist/chunk-3ASUQ6PA.mjs
var import_jsx_runtime69 = __toESM(require_jsx_runtime(), 1);
var HStack = forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(Stack, { align: "center", ...props, direction: "row", ref }));
...
var Circle = forwardRef(function Circle2(props, ref) {
  ...
  return (0, import_jsx_runtime72.jsx)(Square, { size, ref, borderRadius: "9999px", ...rest });
});
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime73.jsx)(import_jsx_runtime73.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime73.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime73.jsx)(import_react119.Fragment, { children: chunk.text }, index2);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  return (0, import_jsx_runtime74.jsx)(chakra.div, { ref, __css: styles, ...rest });
});
...
function Hide(props) {
  ...
  return (0, import_jsx_runtime84.jsx)(Visibility, { breakpoint: query, hide: true, ssr, children });
}
...
function Show(props) {
  const { children, ssr } = props;
  const query = useQuery(props);
  return (0, import_jsx_runtime85.jsx)(Visibility, { breakpoint: query, ssr, children });
}
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime86.jsx)(MenuDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime86.jsx)(MenuProvider, { value: context, children: (0, import_jsx_runtime86.jsx)(MenuStylesProvider, { value: styles, children: runIfFn(children, { isOpen, onClose, forceUpdate }) }) }) });
};
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime88.jsx)(chakra.button, { ref, type: btnType, ...rest, __css: buttonStyles });
  }
);
...
var MenuIcon = (props) => {
  ...
  return (0, import_jsx_runtime89.jsx)(chakra.span, { className: _className, ...rest, __css: styles.icon, children: clone });
};
...
var MenuItem = forwardRef((props, ref) => {
  ...
  const _children = shouldWrap ? (0, import_jsx_runtime90.jsx)("span", { style: { pointerEvents: "none", flex: 1 }, children }) : children;
  return (0, import_jsx_runtime90.jsxs)(
    StyledMenuItem,
    {
      ...
      children: [
        icon && (0, import_jsx_runtime90.jsx)(MenuIcon, { fontSize: "0.8em", marginEnd: iconSpacing, children: icon }),
        _children,
        command && (0, import_jsx_runtime90.jsx)(MenuCommand, { marginStart: commandSpacing, children: command })
      ]
    }
  );
});
...
var MenuGroup = forwardRef((props, ref) => {
  ...
  const styles = useMenuStyles();
  return (0, import_jsx_runtime92.jsxs)("div", { ref, className: "chakra-menu__group", role: "group", children: [
    title && (0, import_jsx_runtime92.jsx)(chakra.p, { className: _className, ...rest, __css: styles.groupTitle, children: title }),
    children
  ] });
});
...
var CheckIcon3 = (props) => (0, import_jsx_runtime96.jsx)("svg", { viewBox: "0 0 14 14", width: "1em", height: "1em", ...props, children: (0, import_jsx_runtime96.jsx)(
  "polygon",
  {
    fill: "currentColor",
  ...
  (props, ref) => {
    ...
    return (0, import_jsx_runtime96.jsxs)(
      StyledMenuItem,
      {
        ...
        children: [
          icon !== null && (0, import_jsx_runtime96.jsx)(
            MenuIcon,
            {
              fontSize: "0.8em",
              marginEnd: iconSpacing,
              opacity: props.isChecked ? 1 : 0,
              children: icon || (0, import_jsx_runtime96.jsx)(CheckIcon3, {})
            }
          ),
          (0, import_jsx_runtime96.jsx)("span", { style: { flex: 1 }, children: optionProps.children })
        ]
      }
    );
  }
...
var ModalTransition = (0, import_react135.forwardRef)(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime97.jsx)(MotionSection, { ref, ...motionProps, ...rest });
  }
);
...
function useModalManager(ref, isOpen) {
  const [index2, setIndex] = (0, import_react136.useState)(0);
...
var Modal = (props) => {
  ...
  return (0, import_jsx_runtime98.jsx)(ModalContextProvider, { value: context, children: (0, import_jsx_runtime98.jsx)(ModalStylesProvider, { value: styles, children: (0, import_jsx_runtime98.jsx)(AnimatePresence, { onExitComplete: onCloseComplete, children: context.isOpen && (0, import_jsx_runtime98.jsx)(Portal, { ...portalProps, children }) }) }) });
};
...
var ModalContent = forwardRef(
  (props, ref) => {
    ...
    return (0, import_jsx_runtime100.jsx)(ModalFocusScope, { children: (0, import_jsx_runtime100.jsx)(
      chakra.div,
      {
        ...containerProps,
...
function AlertDialog(props) {
  ...
  return (0, import_jsx_runtime101.jsx)(Modal, { ...rest, initialFocusRef: leastDestructiveRef });
}
var AlertDialogContent = forwardRef(
  (props, ref) => (0, import_jsx_runtime101.jsx)(ModalContent, { ref, role: "alertdialog", ...props })
);
...
function Drawer(props) {
  ...
  return (0, import_jsx_runtime102.jsx)(DrawerContextProvider, { value: { placement }, children: (0, import_jsx_runtime102.jsx)(
    Modal,
    {
      isOpen,
      onClose,
...
var TriangleDownIcon = (props) => (0, import_jsx_runtime109.jsx)(Icon, { viewBox: "0 0 24 24", ...props, children: (0, import_jsx_runtime109.jsx)(
  "path",
  {
    fill: "currentColor",
...
var TriangleUpIcon = (props) => (0, import_jsx_runtime109.jsx)(Icon, { viewBox: "0 0 24 24", ...props, children: (0, import_jsx_runtime109.jsx)(
  "path",
  {
    fill: "currentColor",
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    return (0, import_jsx_runtime110.jsx)(NumberInputProvider, { value: ctx, children: (0, import_jsx_runtime110.jsx)(NumberInputStylesProvider, { value: styles, children: (0, import_jsx_runtime110.jsx)(
      chakra.div,
      {
        ...htmlProps,
        ref,
...
var NumberDecrementStepper = forwardRef(function NumberDecrementStepper2(props, ref) {
  ...
  return (0, import_jsx_runtime110.jsx)(StyledStepper, { ...decrement, __css: styles.stepper, children: (_a2 = props.children) != null ? _a2 : (0, import_jsx_runtime110.jsx)(TriangleDownIcon, {}) });
});
...
var NumberIncrementStepper = forwardRef(function NumberIncrementStepper2(props, ref) {
  ...
  const styles = useNumberInputStyles();
  return (0, import_jsx_runtime110.jsx)(StyledStepper, { ...increment, __css: styles.stepper, children: (_a2 = props.children) != null ? _a2 : (0, import_jsx_runtime110.jsx)(TriangleUpIcon, {}) });
});
...
function PinInput(props) {
  ...
  return (0, import_jsx_runtime111.jsx)(PinInputDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime111.jsx)(PinInputProvider, { value: context, children: clones }) });
}
...
function Popover(props) {
  ...
  return (0, import_jsx_runtime113.jsx)(PopoverProvider, { value: context, children: (0, import_jsx_runtime113.jsx)(PopoverStylesProvider, { value: styles, children: runIfFn(children, {
...
var Circle3 = (props) => (0, import_jsx_runtime120.jsx)(chakra.circle, { cx: 50, cy: 50, r: 42, fill: "transparent", ...props });
  ...
  (props, ref) => {
    ...
    return (0, import_jsx_runtime122.jsxs)(
      chakra.div,
      {
        ...
        __css: rootStyles2,
        children: [
          (0, import_jsx_runtime122.jsxs)(Shape, { size, isIndeterminate, children: [
...
var Progress = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime123.jsx)(
    chakra.div,
    {
      ...
      __css: trackStyles,
      ...rest,
      children: (0, import_jsx_runtime123.jsxs)(ProgressStylesProvider, { value: styles, children: [
...
var ProgressLabel = (props) => {
  ...
  return (0, import_jsx_runtime124.jsx)(chakra.div, { ...props, __css: labelStyles });
};
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime125.jsx)(RadioGroupProvider, { value: group, children: (0, import_jsx_runtime125.jsx)(
    chakra.div,
    {
...
var Radio = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime126.jsxs)(chakra.label, { className: "chakra-radio", ...rootProps, __css: rootStyles2, children: [
    (0, import_jsx_runtime126.jsx)("input", { className: "chakra-radio__input", ...inputProps }),
  ...
  function SelectField2(props, ref) {
    ...
    return (0, import_jsx_runtime127.jsxs)(
      chakra.select,
      {
        ...
        children: [
          placeholder && (0, import_jsx_runtime127.jsx)("option", { value: "", children: placeholder }),
          children
        ]
      }
    );
...
var DefaultIcon = (props) => (0, import_jsx_runtime128.jsx)("svg", { viewBox: "0 0 24 24", ...props, children: (0, import_jsx_runtime128.jsx)(
  "path",
  {
    fill: "currentColor",
    d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"
...
var SelectIcon = (props) => {
  const { children = (0, import_jsx_runtime128.jsx)(DefaultIcon, {}), ...rest } = props;
  ...
  return (0, import_jsx_runtime128.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react154.isValidElement)(children) ? clone : null });
};
...
var SkeletonCircle = ({
  size = "2rem",
  ...rest
}) => (0, import_jsx_runtime130.jsx)(Skeleton, { borderRadius: "full", boxSize: size, ...rest });
...
var SkeletonText = (props) => {
  ...
  return (0, import_jsx_runtime131.jsx)(chakra.div, { className: _className, ...rest, children: numbers.map((number2, index2) => {
...
var SkipNavLink = forwardRef(
  function SkipNavLink2(props, ref) {
    ...
    return (0, import_jsx_runtime132.jsx)(chakra.a, { ...rest, ref, href: `#${id3}`, __css: getStyles2(styles) });
  }
);
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    return (0, import_jsx_runtime133.jsx)(RangeSliderProvider, { value: ctx, children: (0, import_jsx_runtime133.jsx)(RangeSliderStylesProvider, { value: styles, children: (0, import_jsx_runtime133.jsx)(
      chakra.div,
      {
        ...getRootProps({}, ref),
  ...
  function RangeSliderThumb2(props, ref) {
    ...
    return (0, import_jsx_runtime133.jsxs)(
      chakra.div,
      {
        ...
        children: [
          thumbProps.children,
          name && (0, import_jsx_runtime133.jsx)("input", { ...getInputProps({ index: props.index }) })
        ]
      }
    );
  }
...
var Slider = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime134.jsx)(SliderProvider, { value: context, children: (0, import_jsx_runtime134.jsx)(SliderStylesProvider, { value: styles, children: (0, import_jsx_runtime134.jsxs)(
    chakra.div,
    {
      ...rootProps,
      ...
      children: [
        ...
        (0, import_jsx_runtime134.jsx)("input", { ...inputProps })
      ]
    }
  ) }) });
});
...
var Stat = forwardRef(function Stat2(props, ref) {
  ...
  return (0, import_jsx_runtime135.jsx)(StatStylesProvider, { value: styles, children: (0, import_jsx_runtime135.jsx)(
    chakra.div,
    {
      ref,
      ...rest,
      ...
      __css: statStyles,
      children: (0, import_jsx_runtime135.jsx)("dl", { children })
    }
  ) });
});
...
var StatDownArrow = (props) => (0, import_jsx_runtime136.jsx)(Icon, { color: "red.400", ...props, children: (0, import_jsx_runtime136.jsx)(
  "path",
  {
    fill: "currentColor",
    d: "M21,5H3C2.621,5,2.275,5.214,2.105,5.553C1.937,5.892,1.973,6.297,2.2,6.6l9,12 c0.188,0.252,0.485,0.4,0.8,0.4s0.611-0.148,0.8-0.4l9-12c0.228-0.303,0.264-0.708,0.095-1.047C21.725,5.214,21.379,5,21,5z"
...
function StatUpArrow(props) {
  return (0, import_jsx_runtime136.jsx)(Icon, { color: "green.400", ...props, children: (0, import_jsx_runtime136.jsx)(
    "path",
    {
      fill: "currentColor",
      d: "M12.8,5.4c-0.377-0.504-1.223-0.504-1.6,0l-9,12c-0.228,0.303-0.264,0.708-0.095,1.047 C2.275,18.786,2.621,19,3,19h18c0.379,0,0.725-0.214,0.895-0.553c0.169-0.339,0.133-0.744-0.095-1.047L12.8,5.4z"
...
function StatArrow(props) {
  ...
  return (0, import_jsx_runtime136.jsxs)(import_jsx_runtime136.Fragment, { children: [
    (0, import_jsx_runtime136.jsx)(chakra.span, { srOnly: true, children: label }),
    (0, import_jsx_runtime136.jsx)(BaseIcon, { "aria-hidden": true, ...rest, __css: styles.icon })
  ] });
}
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  return (0, import_jsx_runtime143.jsx)(
    chakra.div,
    {
      ...
      children: (0, import_jsx_runtime143.jsx)(StepperStylesProvider, { value: styles, children: stepElements.map((child, index22) => (0, import_jsx_runtime143.jsx)(
        StepContextProvider,
        {
          value: {
            index: index22,
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react164.useState)(index2);
...
function StepStatus(props) {
  ...
  return render ? (0, import_jsx_runtime145.jsx)(import_jsx_runtime145.Fragment, { children: render }) : null;
}
...
function StepIndicatorContent() {
  return (0, import_jsx_runtime149.jsx)(
    StepStatus,
    {
      complete: (0, import_jsx_runtime149.jsx)(StepIcon, {}),
      incomplete: (0, import_jsx_runtime149.jsx)(StepNumber, {}),
      active: (0, import_jsx_runtime149.jsx)(StepNumber, {})
    }
  );
}
...
var Table = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime152.jsx)(TableStylesProvider, { value: styles, children: (0, import_jsx_runtime152.jsx)(
    chakra.table,
    {
      ref,
...
var Thead = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime153.jsx)(chakra.thead, { ...props, ref, __css: styles.thead });
});
...
var Tr = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime154.jsx)(chakra.tr, { ...props, ref, __css: styles.tr });
});
...
var Tbody = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime157.jsx)(chakra.tbody, { ...props, ref, __css: styles.tbody });
});
...
var Tfoot = forwardRef((props, ref) => {
  const styles = useTableStyles();
  return (0, import_jsx_runtime159.jsx)(chakra.tfoot, { ...props, ref, __css: styles.tfoot });
});
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react166.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  return (0, import_jsx_runtime161.jsx)(TabsDescendantsProvider, { value: descendants, children: (0, import_jsx_runtime161.jsx)(TabsProvider, { value: context, children: (0, import_jsx_runtime161.jsx)(TabsStylesProvider, { value: styles, children: (0, import_jsx_runtime161.jsx)(
    chakra.div,
    {
...
var Tag = forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime167.jsx)(TagStylesProvider, { value: styles, children: (0, import_jsx_runtime167.jsx)(chakra.span, { ref, ...ownProps, __css: containerStyles }) });
});
Tag.displayName = "Tag";
var TagLabel = forwardRef((props, ref) => {
  const styles = useTagStyles();
  return (0, import_jsx_runtime167.jsx)(chakra.span, { ref, noOfLines: 1, ...props, __css: styles.label });
});
TagLabel.displayName = "TagLabel";
var TagLeftIcon = forwardRef((props, ref) => (0, import_jsx_runtime167.jsx)(Icon, { ref, verticalAlign: "top", marginEnd: "0.5rem", ...props }));
TagLeftIcon.displayName = "TagLeftIcon";
var TagRightIcon = forwardRef((props, ref) => (0, import_jsx_runtime167.jsx)(Icon, { ref, verticalAlign: "top", marginStart: "0.5rem", ...props }));
